  ...
  return (
    <form id="form" onSubmit={onSubmit}>
      ...
      <input value={props.newQuestion} maxLength={50}
       onChange={evt => props.inputChange({...props, newQuestion: evt.target.value})} id="newQuestion" placeholder="Enter question" />

      <input value={props.newTrueAnswer} maxLength={50} 
      onChange={evt => props.inputChange({...props, newTrueAnswer: evt.target.value})} id="newTrueAnswer" placeholder="Enter true answer" />

      <input value={props.newFalseAnswer} maxLength={50} 
      onChange={evt => props.inputChange({...props, newFalseAnswer: evt.target.value})} id="newFalseAnswer" placeholder="Enter false answer" />
